...
async function solveSingleQs(newTab, link) {
    ...
    console.log(1);
   // newTab.goto("https://www.hackerrank.com/administration/challenges/edit/169086/moderators",{ waitUntil: "networkidle0" });
   await newTab.waitForSelector("a.cursor.change-tab.cep",
   { visible: true });
   console.log(2);
await newTab.click("a.cursor.change-tab.cep"); 
console.log(3);
//newTab.click(".cursor change-tab cep");
  //  await newTab.waitForSelector(".wide ui-autocomplete-input",
    //    { visible: true });
    //await newTab.click(".wide ui-autocomplete-input");
   // await newTab.type(".wide ui-autocomplete-input", "pranjal");
    //btn moderator-save
